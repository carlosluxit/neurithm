...
function welcomeEmail(name: string) {
  return {
    subject: 'Welcome to the Luxit Newsletter',
    html: `
      <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 600px; margin: 0 auto; background: #050510; color: #f0f0f5;">
        <div style="padding: 40px;">
          ...
          <p style="color: #8a8a9a; text-align: center; font-size: 15px; margin-bottom: 32px;">
            Hi ${name || 'there'}, welcome to the Luxit newsletter. You'll get weekly insights on AI transformation, new case studies, and actionable frameworks.
          </p>
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="https://luxit.io/assessment" style="display: inline-block; background: linear-gradient(135deg, #2EA3F2 0%, #1A7CC4 100%); color: white; padding: 14px 32px; border-radius: 12px; text-decoration: none; font-weight: 500; font-size: 15px;">
